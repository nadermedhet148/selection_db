module.exports = async $this => {
  // the main table
  let table = "treatmentExtraFamilyMembersEndTerm",
    mainKey = "militaryIdConscript",
    conscripteTable = "conscriptesEndTrmenations",
    cardTable = "treatmentCardEndTrmnationRegDiv",
